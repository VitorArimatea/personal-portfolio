...
const Footer = () => {
  return (
    <footer className="pt-20 pb-10 px-5 bg-[#111]" id="contact">
      <div className="flex flex-col items-center">
        <h1 className="heading lg:max-w-[45vw] text-[#f1f1f1]">
          Pronto para levar{" "}
          <span className="text-blue-400">sua presença digital</span> ao próximo
          nível?
        </h1>
      ...
      <div className="flex mt-10 md:mt-15 flex-col-reverse gap-5 md:flex-row justify-between items-center">
        <p className="text-[13px] md:text-base font-light md:font-normal text-[#fff]">
